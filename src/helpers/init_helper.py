...
def get_parser() -> argparse.ArgumentParser:
    ...
    # model type
    #parser.add_argument('model', type=str, default = "anchor-free",
    ...
    parser.add_argument('--model-dir', type=str, default=r'C:\Users\matti\github\vsummapp\models\ab_mobilenet')
    ...
    parser.add_argument('--base-model', type=str, default='attention',
                        choices=['attention', 'lstm', 'linear', 'bilstm',
                                 'gcn'])
    parser.add_argument('--num-head', type=int, default=10)
    parser.add_argument('--num-feature', type=int, default=1280)
    ...
    # inference
    parser.add_argument('--video_path', type=str, default=r"C:\Users\matti\github\vsummapp\gallery")
    parser.add_argument('--video_name', type=str, default="Fire_Domino.mp4")
    parser.add_argument('--output_path', type=str, default=r"C:\Users\matti\github\vsummapp\summary")
    parser.add_argument('--segment_algo', type=str, default='kts',
        ...
        # us - Uniform Sampling
    parser.add_argument('--cnn', type=str, default='mobilenet',
